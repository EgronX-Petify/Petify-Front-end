...
const News = () => {
  const news = [
    ...
    },
    {
      ...
      photo:
        "/public/home-media/people-world-cutest-dog-contest-2-pedigree-062525-7a4ba847f3dd4b7ea76e4258f073ef45.jpg",
    ...
    },
    {
      ...
      photo:
        "/public/home-media/APPA-Survey-Art-for-Goodnewsforpets-1024x491.png",
    ...
    },
    {
      ...
      photo:
        "/public/home-media/2025-GoGo-Photo-Banner_Open-Now_FB-Event-scaled.webp",
